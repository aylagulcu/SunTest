...
public class GUI implements Runnable {
    ...
    static final String 
        ...
        TITLE = " için güneþ saati -- ", VER = "Va0",
    ...
    public GUI() {
        ...
        else model.setLocation(Location.Istanbul);
        p2.add(Box.createHorizontalStrut(GAP));
        if (menuM!=null) p2.add(menuM);
        else model.setMethod(Method.Normal);
    ...
    class Panel extends JPanel {  // View
        ...
        void drawTime(Graphics g) {
            ...
            g.drawString(model.ddMMyyyy(), GAP, y); 
